...
//        canvas.drawText("" + value, cellSize / 2, cellSize / 2 - textShiftY, paint);
    ...
    private void drawScoreText(Canvas canvas) {
        ...
        backgroundRectangle.draw(canvas);
        paint.setTextSize(titleTextSize);
        paint.setColor(getResources().getColor(R.color.high_score));
    ...
    private void drawNewGameButton(Canvas canvas, boolean lightUp) {
        ...
        drawDrawable(canvas,
                getResources().getDrawable(R.drawable.ic_action_refresh),
                sXNewGame + iconPaddingSize * 5,
                sYIcons + iconPaddingSize * 5,
                sXNewGame + iconSize - iconPaddingSize * 5,
                sYIcons + iconSize - iconPaddingSize * 5
        );
    }
...
//                startingX, endingY - textShiftY + textPaddingSize, paint);
        ...
        layout.measure(startingX, endingY - textShiftY + textPaddingSize);
        layout.layout(100, 1000, startingX, endingY - textShiftY + textPaddingSize);
    }
    ...
    private void drawBackgroundGrid(Canvas canvas) {
        ...
        for (int xx = 0; xx < GlobalApp.numSquaresX; xx++) {
            for (int yy = 0; yy < GlobalApp.numSquaresY; yy++) {
...
//        drawInstructions(canvas);
    ...
    private int[] getCellRectangleIds() {
        ...
        cellRectangleIds[1] = R.drawable.icon_1;
        cellRectangleIds[2] = R.drawable.icon_2;
        cellRectangleIds[3] = R.drawable.icon_3;
        cellRectangleIds[4] = R.drawable.icon_4;
        cellRectangleIds[5] = R.drawable.icon_5;
        cellRectangleIds[6] = R.drawable.icon_6;
        cellRectangleIds[7] = R.drawable.icon_7;
        cellRectangleIds[8] = R.drawable.icon_8;
        cellRectangleIds[9] = R.drawable.icon_9;
        cellRectangleIds[10] = R.drawable.icon_10;
        cellRectangleIds[11] = R.drawable.icon_11;
        for (int xx = 12; xx < cellRectangleIds.length; xx++) {
            cellRectangleIds[xx] = R.drawable.icon_12;
        }
    ...
    private void getLayout(int width, int height) {
        cellSize = Math.min(width / (GlobalApp.numSquaresX + 1), height / (GlobalApp.numSquaresY + 3));
        ...
        //Grid Dimensions
        double hafyX = GlobalApp.numSquaresX / 2d;
        double hafyY = GlobalApp.numSquaresY / 2d;
        startingX = (int) (screenMiddleX - (cellSize + gridWidth) * hafyX - gridWidth / 2);
        endingX = (int) (screenMiddleX + (cellSize + gridWidth) * hafyX + gridWidth / 2);
        startingY = (int) (boardMiddleY - (cellSize + gridWidth) * hafyY - gridWidth / 2);
        endingY = (int) (boardMiddleY + (cellSize + gridWidth) * hafyY + gridWidth / 2);
